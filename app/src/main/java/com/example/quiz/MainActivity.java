...
public class MainActivity extends AppCompatActivity {
    ...
    quiz_item_adapter adapter;
    quiz_item_adapter.OnItemClickListener mListener;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // 화면 구성 View 전달
        textView_question_number = findViewById(R.id.question_number);
        textView_question = findViewById(R.id.question);
        button_next_question = findViewById(R.id.button_next_question);
        button_previous_question = findViewById(R.id.button_previous_question);
        ...
        recyclerView = findViewById(R.id.recyclerview_quizitem) ;
        ...
        //quiz 정답/오답처리 리스너
        mListener = new quiz_item_adapter.OnItemClickListener() {
            @Override
        ...
        adapter = new quiz_item_adapter(getResources().getStringArray(R.array.Q1));
    ...
    public void changeQuestion(boolean up){
        ...
        if (current_number>=1){
            ...
            int id = getApplicationContext().getResources().getIdentifier("Q"+current_number,
                    "array", getApplicationContext().getPackageName());

            adapter = new quiz_item_adapter(getResources().getStringArray(id));
            adapter.setOnItemClickListener(mListener);
            recyclerView.setAdapter(adapter) ;
        }
    ...
    public void show_score(){
        ...
        View view = LayoutInflater.from(MainActivity.this).inflate(R.layout.score_page, null, false);
