...
//        returnBtn = (Button) findViewById(R.id.second_returnBtn);
        ...
        viewPager.setAdapter(new TextViewPagerAdapter(this, imageList, test));
        ...
        switch (Index) {
            case 0:
                ...
                break;
            case 1:
                viewPager.setAdapter(new TextViewPagerAdapter(this, imageList, test1));
                ...
                break;
            case 2:
                viewPager.setAdapter(new TextViewPagerAdapter(this, imageList, hy));
            ...
            case 3:
                ...
                viewPager.setAdapter(new TextViewPagerAdapter(this, imageList, burn));
